...
<div class="container">
	...
	<div class="row clearfix">
		...
		<div class="col-md-6 column">
			<form class="form-horizontal" role="form" action="EmployeeAptAdd.do" onsubmit="return checkEmployeeAptAdd(this)" method="post">
				...
				<div class="form-group">
					<div class="col-sm-offset-4 col-sm-10">
						 <button class="btn btn-success btn-lg" type="submit">添加公寓</button>
					</div>
				</div>
			</form>
			<c:if test="${msg == '1'}">
