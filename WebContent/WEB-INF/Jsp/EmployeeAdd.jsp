...
<div class="container">
	...
	<div class="row clearfix">
		...
		<div class="col-md-6 column">
			<form class="form-horizontal" role="form" action="EmployeeAdd.do" onsubmit="return checkEmpAdd(this)" method="post">
				...
				<div class="form-group">
					...
					<div class="col-sm-7">
						<input class="form-control" id="startTimePicker" name="inductionTime" readonly />
					</div>
				</div>
				<div id="depTimeCollapse" class="collapse">
					<div class="form-group">
						...
						<div class="col-sm-7">
							<input class="form-control" id="endTimePicker" name="departureTime" readonly/>
						</div>
					</div>
				</div>
				<div class="form-group">
