...
<div class="container">
	...
	<div class="row clearfix">
		...
		<div class="col-md-6 column">
			<form class="form-horizontal" role="form" action="StudentModify.do" method="post">
				...
				<div class="form-group">
					...
					<div class="col-sm-7">
						<input class="form-control" id="name" name="name" type="text" value="${modifyStu.name}"/>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-7">
						<select class="form-control" id="sex" name="sex" >
							<option value="0" <c:if test="${modifyStu.sex == '0'}"> selected="selected" </c:if>>男</option>
							<option value="1" <c:if test="${modifyStu.sex == '1'}"> selected="selected" </c:if>>女</option>
						</select>	
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-7">
						<input class="form-control" id="phone" name="phone" type="text" value="${modifyStu.phone}"/>
					</div>
				</div>
				<div class="form-group">
					 	<label class="col-sm-2 control-label" for="inputDepTime">创建时间</label>
						<div class="col-sm-7">
				...
				<div class="form-group">
					<div class="col-sm-offset-4 col-sm-10">
						 <button class="btn btn-success btn-lg" type="submit">修改学生</button>
					</div>
				</div>
			</form>
			<c:if test="${msg == '0'}">
