...
<div class="container">
	...
	<div class="row clearfix">
		...
		<div class="col-md-6 column">
			<form class="form-horizontal" role="form" action="VisitRecordModify.do" onsubmit="return checkRecModify(this)" method="post">
				<div class="form-group">
					<label class="col-sm-2 control-label" for="inputName">记录ID</label>
					<div class="col-sm-7">
						<input class="form-control" id="recIdDisplay" type="text" value="<c:out value="${modifyRec.id}" />" disabled/>
						<input class="form-control" id="id" name="id" type="hidden" value="<c:out value="${modifyRec.id}" />"/>
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-2 control-label" for="inputName">姓名</label>
					<div class="col-sm-7">
						<input class="form-control" id="name" name="name" type="text" value="<c:out value="${modifyRec.visitorName}" />"/>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-7">
						<select class="form-control" id="sex" name="sex" >
							<option value="0" <c:if test="${modifyRec.visitorSex == '0'}"> selected="selected" </c:if>>男</option>
							<option value="1" <c:if test="${modifyRec.visitorSex == '1'}"> selected="selected" </c:if>>女</option>
						</select>	
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-7">
						<input class="form-control" id="phone" name="phone" type="text" value="<c:out value="${modifyRec.visitorPhone}" />" />
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-2 control-label" for="inputIdCard">证件号码</label>
					<div class="col-sm-7">
						<input class="form-control" id="idCard" name="idCard" type="text" value="<c:out value="${modifyRec.visitorIdCard}" />" />
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-7">
                    	<div class="input-group">
                   			<c:if test="${modifyRec.visitRoom != null && modifyRec.visitRoom.apartment != null}">
                        		<input type="text" class="form-control" id="apartmentSelect" autocomplete="off" value="<c:out value="${modifyRec.visitRoom.apartment.name}" />" >
                        		<input class="form-control" id="aptId" type="hidden" value="<c:out value="${modifyRec.visitRoom.apartment.id}" />" />
                        	</c:if>
                        	<c:if test="${modifyRec.visitRoom == null || modifyRec.visitRoom.apartment == null}">
                        		<input type="text" class="form-control" id="apartmentSelect" autocomplete="off" value="" />" >
                ...
                <div class="form-group">
					...
					<div class="col-sm-7">
                    	<div class="input-group">
                    		<c:if test="${modifyRec.visitRoom != null}">
                        		<input type="text" class="form-control" id="roomSelect" autocomplete="off" value="<c:out value="${modifyRec.visitRoom.name}" />" >
                        		<input class="form-control" id="roomId" name="roomId" type="hidden" value="<c:out value="${modifyRec.visitRoom.id}" />" />
                        	</c:if>
                        	<c:if test="${modifyRec.visitRoom == null}">
                        		<input type="text" class="form-control" id="roomSelect" autocomplete="off" value="" />" >
                ...
                <div class="form-group">
					...
					<div class="col-sm-7">
						<input class="form-control" id="startTimePicker" name="enterTime" value="<c:out value="${enterTimeStr}" />" readonly />
					</div>
				</div>
				<div class="form-group">
					 <label class="col-sm-2 control-label" for="inputLevTime">离开时间</label>
					<div class="col-sm-7">
						<input class="form-control" id="endTimePicker" name="leaveTime" value="<c:out value="${leaveTimeStr}" />" readonly />
					</div>
				</div>
				<div class="form-group">
					 	<label class="col-sm-2 control-label" for="inputCreateTime">创建时间</label>
						<div class="col-sm-7">
				...
				<div class="form-group">
					<div class="col-sm-offset-4 col-sm-10">
						 <button class="btn btn-success btn-lg" type="submit">修改记录</button>
					</div>
				</div>
			</form>
			<c:if test="${msg == '0'}">
