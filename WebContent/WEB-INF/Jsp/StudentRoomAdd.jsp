...
<div class="container">
	...
	<div class="row clearfix">
		...
		<div class="col-md-6 column">
			<form class="form-horizontal" role="form" action="StudentRoomAdd.do" onsubmit="return checkStudentRoomAdd(this)" method="post">
				<div class="form-group">
					<label class="col-sm-2 control-label" for="inputStu">选择公寓</label>
					<div class="col-sm-7">
				...
				<div class="form-group">
                	<label class="col-sm-2 control-label" for="inputRoom">选择房间</label>
					<div class="col-sm-7">
                    	<div class="input-group">
