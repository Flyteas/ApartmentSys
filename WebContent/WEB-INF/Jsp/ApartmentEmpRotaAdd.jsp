			...
			<form class="form-horizontal" role="form" action="RotaAdd.do" onsubmit="return checkRotaAdd(this)" method="post">
				<div class="form-group">
					...
					<div class="col-sm-7">
						...
						<input class="form-control" id="aptId" name="aptId" type="hidden" value="${aptEmp.apartment.id}"/>
						<input class="form-control" id="empId" name="empId" type="hidden" value="${aptEmp.employee.empId}"/>
					</div>
				</div>
				<div class="form-group">
