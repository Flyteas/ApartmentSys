...
public interface VisitRecordDao 
{
	...
	public List<VisitRecord> getAll(int page,int pageSize); //获取所有记录，分页
	...
	public List<VisitRecord> findByNameOrPhone(String keyword,int page,int pageSize); //姓名电话查找 分页
	public long findByNameOrPhoneSize(String keyword); //姓名电话查找结果数
